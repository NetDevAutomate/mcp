...
def _create_client(
    ...
    if profile:
        ...
        return session.client(
            service, config=config, region_name=region, endpoint_url=endpoint_url
        )
...
class DateTimeEncoder(json.JSONEncoder):
    ...
    def default(self, obj):
        """Return a JSON-serializable representation of datetime objects."""
...
async def trace_network_path(
    source_ip: str, destination_ip: str, region: str | None = None
) -> str:
...
async def analyze_segment_routes(
    core_network_id: str, segment_name: str, region: str | None = None
) -> str:
...
async def aws_config_manager(
    operation: str, profile: str | None = None, region: str | None = None
) -> str:
        ...
        if operation == 'get_current':
            ...
            result = {
                ...
                'current_configuration': {
                    ...
                    'cache_entries': getattr(_client_cache, 'currsize', 0),
                },
            }
            ...
            try:
                ...
                if config_persistence:
                    ...
                    logger.warning('Config persistence unavailable - changes not saved')
