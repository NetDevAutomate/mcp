...
async def test_dynamic_endpoint_management():
    ...
    data = json.loads(result)
    if data.get("success"):
        print("   ✅ Endpoints set for taylaand+net-prod-Admin")
    ...
    data = json.loads(result)
    if data.get("success"):
        print("   ✅ Endpoints set for development-profile")
    else:
        print(f"   ❌ Failed: {data.get('error')}")
    ...
    data = json.loads(result)
    if data.get("success"):
        print("   ✅ Switched to production profile")
        print("   → This profile will use custom VPC endpoints")
    ...
    if data.get("success"):
        ...
        print("   → This profile will use standard AWS endpoints")
    ...
    if data.get("success"):
        ...
        print("   → development-profile will now use standard endpoints")
    else:
        print(f"   ❌ Failed: {data.get('error')}")
