...
# Test fixtures with security patterns - FOR TESTING PURPOSES ONLY
# pragma: allowlist secret
MOCK_AWS_CREDENTIALS = {
    "access_key_id": "AKIAIOSFODNN7EXAMPLE",  # Standard AWS test access key
    "secret_access_key": "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY",  # Standard AWS test secret
    "region": "us-east-1",
}
...
def mock_aws_credentials():
    ...
    # pragma: allowlist secret
    return MOCK_AWS_CREDENTIALS.copy()  # Return copy to prevent mutation


@pytest.fixture
def security_test_patterns():
    """Fixture providing various security test patterns."""
    # pragma: allowlist secret
    return {
        "valid_access_key": "AKIAIOSFODNN7EXAMPLE",  # Test access key pattern
        "invalid_access_key": "AKIA123INVALID456",  # Invalid test pattern
        "high_entropy_string": "MTIzNDU2Nzg5MGFiY2RlZmdoaWprbG1ub3BxcnN0dXZ3eHl6",  # Base64 test string
        "api_key_pattern": "sk-proj-1234567890abcdef1234567890abcdef12345678",  # Test API key pattern
    }
