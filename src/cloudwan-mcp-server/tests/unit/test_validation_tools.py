...
def mock_get_aws_client() -> Generator:  # Added return type
    ...
    with patch(
        'awslabs.cloudwan_mcp_server.server.get_aws_client', side_effect=_mock_client
    ) as mock:
        yield mock
...
class TestValidationTools:
    ...
    @pytest.mark.asyncio
    async def test_validate_ip_cidr_validate_ip(
        self, mock_get_aws_client: Generator
    ) -> None:  # Added type
    ...
    @pytest.mark.asyncio
    async def test_validate_ip_cidr_validate_cidr(
        self, mock_get_aws_client: Generator
    ) -> None:  # Added type
    ...
    @pytest.mark.asyncio
    async def test_validate_ip_cidr_invalid_operation(
        self, mock_get_aws_client: Generator
    ) -> None:  # Added type
    ...
    @pytest.mark.asyncio
    async def test_validate_cloudwan_policy(
        self, mock_get_aws_client: Generator
    ) -> None:  # Added type
    ...
    async def test_analyze_tgw_peers_error(self, mock_aws_client) -> None:
        ...
        mock_aws_client.describe_transit_gateway_peering_attachments.side_effect = Exception(
            'API error'
        )
