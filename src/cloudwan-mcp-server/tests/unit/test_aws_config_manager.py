...
"""Test AWS configuration manager with security validation."""
...
# Test configuration patterns - NOT REAL AWS CREDENTIALS
# pragma: allowlist secret
TEST_PROFILE_NAME = "test-profile-AKIAIOSFODNN7EXAMPLE"  # Test profile with access key pattern
# pragma: allowlist secret
TEST_REGION_CONFIG = "us-east-1-wJalrXUtnFEMI"  # Test region with high entropy suffix
...
class TestAWSConfigManager:
    ...
    @patch.dict(
        "os.environ",
        {
            "AWS_PROFILE": TEST_PROFILE_NAME,  # pragma: allowlist secret
            "AWS_DEFAULT_REGION": "us-east-1",
        },
    )
    def test_profile_configuration_with_security_patterns(self):
        """Test profile configuration handling with security patterns."""
        # ... existing code ...

    def test_credential_validation_patterns(self):
        """Test credential validation with various patterns."""
        # pragma: allowlist secret
        invalid_key = "AKIA1234567890ABCDEF"  # Invalid test access key pattern
