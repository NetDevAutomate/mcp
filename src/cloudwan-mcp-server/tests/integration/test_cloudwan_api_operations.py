    ...
    async def test_list_core_networks_success_with_data(self) -> None:
        ...
        sample_networks = [
            ...
            },
            {
                ...
                'State': 'AVAILABLE',
                'CreatedAt': datetime(2024, 1, 16, 11, 45, 30, tzinfo=UTC),
...
class TestValidateCloudWANPolicyOperation:
    ...
    async def test_validate_cloudwan_policy_missing_fields(self) -> None:
        ...
        missing_core_config = next(
            (r for r in validation_results if r['field'] == 'core-network-configuration'), None
        )
...
class TestManageTGWRoutesOperation:
    ...
    async def test_manage_tgw_routes_create(self) -> None:
        ...
        result = await manage_tgw_routes(
            'create', 'tgw-rtb-123456789', '10.0.0.0/16', region='us-east-1'
        )
