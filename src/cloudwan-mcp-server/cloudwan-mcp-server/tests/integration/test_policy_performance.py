...
class TestLargePolicyDocumentParsing:
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_10mb_policy_document_parsing(self):
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_complex_json_schema_validation(self):
...
class TestRegexPerformanceAndDOS:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_regex_dos_prevention_patterns(self):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_compiled_regex_benchmarking(self):
...
class TestPolicyVersionDiffPerformance:
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_large_policy_version_diff_analysis(self):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_policy_render_tree_validation(self):
...
class TestMemoryMappedFileHandling:
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_memory_mapped_policy_processing(self):
...
class TestPolicyCacheInvalidation:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_policy_cache_invalidation_performance(self):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_parallel_policy_validation_performance(self):
