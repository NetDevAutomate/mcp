...
class TestIAMPermissionValidation:
    ...
    @pytest.mark.asyncio
    async def test_iam_access_denied_scenarios(self):
    ...
    @pytest.mark.security
    @pytest.mark.asyncio
    async def test_resource_based_policy_validation(self):
...
class TestPolicyDocumentSecurity:
    ...
    @pytest.mark.security
    @pytest.mark.asyncio
    async def test_malicious_policy_structure_detection(self):
